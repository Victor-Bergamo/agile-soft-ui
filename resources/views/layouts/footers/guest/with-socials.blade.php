      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-lg-8 mx-auto text-center mb-4 mt-2">
                  ...
                  <a href="https://github.com/ganbytte" target="_blank" class="text-secondary me-xl-4 me-4">
          ...
          <div class="row">
              <div class="col-8 mx-auto text-center mt-1">
                  <p class="mb-0 text-secondary">
                      Copyright © {{ now()->year }} Desenvolvido por <a style="color: #252f40;" href="https://www.ganbytte.com.br"
                          class="font-weight-bold ml-1" target="_blank">Ganbytte Software</a> &amp; <a style="color: #252f40;"
                          href="https://www.updivision.com" class="font-weight-bold ml-1" target="_blank">GANAGILE</a>
              </div>
              </p>
          </div>
      </div>
