<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">GanAgile</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user-profile' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Seu Usuário</span>
                </a>
            </li>
            <li class="nav-item pb-2">
        ...
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-left p-3 w-100">
                ...
                <div class="docs-info">
                    ...
                    <p class="text-xs font-weight-bold">Por favor entre em contato</p>
                    <a href="/documentation/bootstrap/overview/soft-ui-dashboard/index.html" target="_blank"
                        class="btn btn-white btn-sm w-100 mb-0">GanAgile Support</a>
                </div>
            </div>
        </div>
    </div>
