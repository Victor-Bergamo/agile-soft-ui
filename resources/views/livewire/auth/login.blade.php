                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            <h3 class="font-weight-bolder text-info text-gradient">{{ __('Bem-vindo de volta') }}</h3>
                        ...
                        <div class="card-body">
                            <form wire:submit.prevent="login" action="#" method="POST" role="form text-left">
                                <div class="mb-3">
                                    <label for="tenantName">{{ __('Tenant') }}</label>
                                    <div class="@error('tenantName')border border-danger rounded-3 @enderror">
                                        <input wire:model="tenantName" id="tenantName" type="text" class="form-control"
                                            placeholder="Digite seu tenant" aria-label="tenantName" aria-describedby="tenantName-addon">
                                    </div>
                                    @error('tenantName') <div class="text-danger">{{ $message }}</div> @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="@error('username')border border-danger rounded-3 @enderror">
                                        <input wire:model="username" id="username" type="text" class="form-control"
                                            placeholder="Digite seu usuário" aria-label="username" aria-describedby="username-addon">
                                    </div>
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="btn bg-gradient-info w-100 mt-4 mb-0">{{ __('Entrar') }}</button>
                                </div>
                            </form>
                        </div>
